...
<div class="wrap">
  ...
  <div class="footer">
    ...
    <div>Gol Sinyal Merkezi v4.1 &nbsp; | &nbsp; Gerçek istatistik, akıllı analiz.</div>
  </div>
</div>
...
<header><div><h1>📅 Maç Önü Tahminleri <span class="version">v4.1</span></h1><p>Maç seç; son maçların formunu ve gol eğilimlerini incele.</p></div>
